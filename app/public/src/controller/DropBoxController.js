class DropBoxController {
  ...
  connectFirebase() {
      ...
      var firebaseConfig = {
          apiKey: "",
          authDomain: "dropbox-clone-f8c3e.firebaseapp.com",
          databaseURL: "https://dropbox-clone-f8c3e.firebaseio.com",
          projectId: "dropbox-clone-f8c3e",
          storageBucket: "dropbox-clone-f8c3e.appspot.com",
          messagingSenderId: "600713267307",
          appId: "1:600713267307:web:9360d4b05cff19b0b5092e",
          measurementId: "G-N32YXEKNSG"
      };
      ...
      li.addEventListener('click', e => {
          ...
          if (e.shiftKey) {
              ...
              if (firstLi) {
                  ...
                  this.listFileEl.dispatchEvent(this.onselectiononchange);
